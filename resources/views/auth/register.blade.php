...
<head>
    ...
    <title>Sinapy School Admin - Registration </title>
                    ...
                    <div class="col-lg-4 col-md-5 col-12">
                        ...
                        <div class="p-30 rounded30 box-shadowed b-2 b-dashed">
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-12 text-center">
                                            <button type="submit"
                                                class="btn btn-info btn-rounded margin-top-10">Register
                                            </button>
                                        </div>
                                        <!-- /.col -->
                                    </div>
                            ...
                            <div class="text-center">
                                <p class="mt-15 mb-0 text-white">{{ __('Already registered?') }}<a
