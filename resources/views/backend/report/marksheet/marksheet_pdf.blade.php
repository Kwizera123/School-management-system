                      ...
                      <div class="box-body" style="border: solid 1px; padding: 10px;">
                        ...
                        <div class="row"> <!-- start 1st row-->
                          <div style="float: right" class="col-md-2 text-center">
                            <img src="{{ url('upload/sinapyschool.png') }}" style="width:120px; height:100px;">
                          </div>
                          ...
                          <div class="col-md-4 text-center" style="float: left">
                            <h4><strong>Zion Education Center</strong></h4>
                             <h6><strong>Huhanga/Cyeza</strong></h6>
                             <h5><strong><u><i>Academic Report</i></u></strong></h5>
